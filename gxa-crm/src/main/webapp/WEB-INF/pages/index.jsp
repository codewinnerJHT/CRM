...
<body>
    <!-- 顶部开始 -->
    <div class="container">
        <div class="logo"><a href="index.jsp">CRM后台管理</a></div>
        <div class="left_open">
      ...
      <div id="side-nav">
        <ul id="nav">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/market/plan/list">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>市场计划</cite>
                        </a>
                    </li >
            ...
            <li>
                ...
                <ul class="sub-menu">
                    <li>
                        <a _href="${pageContext.request.contextPath}/student/list/page">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>学生信息</cite>
                        </a>
                    </li >
